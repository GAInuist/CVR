...
# parser.add_argument('--virtual_image_path', default='./dataset/Sea/images',
...
parser.add_argument('--super_resolution_option', default='./HAT-main/options/test/HAT_SRx4_ImageNet-LR.yml',
...
if __name__ == '__main__':
    ...
    os.system(f'CUDA_VISIBLE_DEVICE=1,0 python SDM/image_sample.py \
