...
def get_transforms(transforms: DictConfig):
    ...
    # T_list.append(AVIAL_TRANSFORM['Norm'](mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225]))
...
class ExtRandomRotation(object):
    ...
    Args:
        ...
        resample ({PIL.Image.NEAREST, PIL.Image.BILINEAR, PIL.Image.BICUBIC}, optional):
            ...
            If omitted, or if the images has mode "1" or "P", it is set to PIL.Image.NEAREST.
        expand (bool, optional): Optional expansion flag.
            If true, expands the output to make it large enough to hold the entire rotated images.
            If false or omitted, make the output images the same size as the input images.
...
class ExtToTensor(object):
    ...
    def __call__(self, pic, lbl):
        ...
        Returns:
            Tensor: Converted images and label
        """
        if self.normalize:
...
class ExtNormalize(object):
    """Normalize a tensor images with mean and standard deviation.
...
class ExtRandomCrop(object):
    ...
    Args:
        ...
        padding (int or sequence, optional): Optional padding on each border
            of the images. Default is 0, i.e no padding. If a sequence of length
...
class ExtResize(object):
    ...
    Args:
        size (sequence or int): Desired output size. If size is a sequence like
            ...
            smaller edge of the images will be matched to this number.
            i.e, if height > width, then images will be rescaled to
...
class ExtColorJitter(object):
    ...
    def get_params(brightness, contrast, saturation, hue):
        """Get a randomized transform to be applied on images.
    ...
    def __call__(self, img, lbl):
        ...
        Returns:
            PIL Image: Color jittered images.
        """
